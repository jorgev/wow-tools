	...
	def do_GET(self):
		if self.path.endswith('.css') or self.path.endswith('.js') or self.path.endswith('.jpg') or self.path.endswith('.gif'):
			...
			if self.path == '/':
				...
				self.wfile.write('<ul>\n')
				self.wfile.write('<li><a class="wow-button" href="/">Home</a></li>\n')
				self.wfile.write('<li><a class="wow-button" href="/raid">View Raid List</a></li>\n')
				self.wfile.write('<li><a class="wow-button" href="/upload">Upload Combat Log</a></li>\n')
				self.wfile.write('</ul>\n')
